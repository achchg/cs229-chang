...
def generate_data_mixture_2D(state, mnist_train, ds_size_list, std_list, category_wt, item):
    ...
    mnist_train_mixture = loaders(trainX_mixture, trainy_mixture)[1]
    mnist_train_rest_mixture = loaders(trainX_rest_mixture, trainy_rest_mixture)[1]
