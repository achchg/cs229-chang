...
def rowStackingModel_inference(obs_X_list, obs_y_list, nonobs_X_list, nonobs_y_list, category_wt1):
    ...
    nonobs_data = define_category(trainy_unselected, category_wt1, item)\
...
def plot1(ds1_size, ds3_size, std_list):
    ...
    plot1.to_csv(f'Data_bias_baseline_acc_{round((1-ds1_size)*100)}_{round((1-ds3_size)*100)}.csv')
...
def just_plot1(plot1):
    ...
    plt.savefig(f'Data_bias_baseline_acc_{round((ds1_size)*100)}_{round((ds3_size)*100)}')
...
def plot2(ds1_size, ds3_size, std_list):
...
#         obs_accuracy_mix_list.append(obs_accuracy_mix)
#         nonobs_accuracy_mix_list.append(nonobs_accuracy_mix)
#         test_accuracy_mix_list.append(test_accuracy_mix)
...
#                             np.array(obs_accuracy_mix_list), 
#                             np.array(nonobs_accuracy_mix_list),
#                             np.array(test_accuracy_mix_list),
...
#                      'Mixed-model obs accuracy', 
#                      'Mixed-model nonobs accuracy', 
#                      'Mixed-model accuracy in TEST set', 
                     'Num obs samples', 
                     'Num nonobs samples']
    
    plot2.to_csv(f'Model_bias_baseline_acc_{round((1-ds1_size)*100)}_{round((1-ds3_size)*100)}.csv')
